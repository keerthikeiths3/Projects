...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="style3">
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBoxAdminUN" runat="server" Width="180px" 
                    ValidationGroup="btnAdmin1"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBoxAdminPwd" runat="server" TextMode="Password" 
                    Width="180px" ValidationGroup="btnAdmin1"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="Login" 
                    Width="70px" ValidationGroup="btnAdmin1" />
