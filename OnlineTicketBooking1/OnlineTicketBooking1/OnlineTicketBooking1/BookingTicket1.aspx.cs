...
public partial class BookingTicket1 : System.Web.UI.Page
{
    ...
    protected void DropDownList2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            con.Open();
            string selectQuery = "select distinct CONVERT(Date,b.Show_Date) from Theatres a,Theatre_Shows b where a.Theatre_Id =  b.Theatre_Id and a.Theatre_Name ='" + drdSelectTheatre.SelectedItem.Text + "'";
            SqlCommand cmd = new SqlCommand(selectQuery, con);
            SqlDataReader dr = cmd.ExecuteReader();
