...
&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="tbxCvv" runat="server"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                    ControlToValidate="tbxPhNo" ErrorMessage="Ph. No. cannot be blank." 
                    Font-Bold="True" Font-Size="Small" ForeColor="#CC0000" 
                    ValidationExpression="((\(\d{3}\) ?)|(\d{3}-))?\d{3}-\d{4}" ValidationGroup="btnBookTicket"></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <td>
